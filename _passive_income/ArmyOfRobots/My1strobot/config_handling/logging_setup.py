...
# -------------------------------------------------------------------
# Section 1: Setup Logging with Dynamic Path Configuration
# -------------------------------------------------------------------
...
# -------------------------------------------------------------------
# Section 2: Feedback Loop for Enhanced Error Tracking (Optional)
# -------------------------------------------------------------------
...
# -------------------------------------------------------------------
# Section 3: Debugging Logging Setup (Optional)
# -------------------------------------------------------------------
...
# -------------------------------------------------------------------
# Example Usage (Dynamic Path and Compatibility)
# -------------------------------------------------------------------

if __name__ == "__main__":
    # Setup logger with environment-based paths and compatibility
    logger = setup_logging("model_training_utils", feedback_loop_enabled=True)
    logger.info("Logging setup successful with feedback loop enabled!")

    # Optional debugging of logging setup
    debug_logging_setup(logger, log_file=Path(os.getenv('LOG_DIR', script_dir.parent / 'logs') / "test_logging.log"))
